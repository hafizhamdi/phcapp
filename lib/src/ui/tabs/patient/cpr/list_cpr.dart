...
import 'cpr_detail.dart';
// import 'edit_cpr.dart';
// import 'new_cpr.dart';

class ListCPR extends StatefulWidget {
  ListCPR();

  _ListCPR createState() => _ListCPR();
}

class _ListCPR extends State<ListCPR>
    with AutomaticKeepAliveClientMixin<ListCPR> {
  @override
  ...
  build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          onPressed: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => CPRDetail()));
          },
